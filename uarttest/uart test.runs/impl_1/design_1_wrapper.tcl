namespace eval ::optrace {
  variable script "/home/test/uarttest/uart test.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {/home/test/uarttest/uart test.cache/wt} [current_project]
  set_property parent.project_path {/home/test/uarttest/uart test.xpr} [current_project]
  set_property ip_output_repo {{/home/test/uarttest/uart test.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{/home/test/uarttest/uart test.runs/synth_1/design_1_wrapper.dcp}}
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files {{/home/test/uarttest/uart test.srcs/sources_1/bd/design_1/design_1.bd}}
